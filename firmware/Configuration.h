...
#define STRING_CONFIG_H_AUTHOR "(Andrej Kenda, Renew3D config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Renew3D"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 29.51
  #define DEFAULT_bedKi 5.00
  #define DEFAULT_bedKd 116.02
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 3, -1.5 }
